...
COPY = "はみだすことは、悪だった"
ONELINE = "クラスで「ハミダシモノ」に立候補した少女は翌日から無視される"
OUTLINE = "約8000字の青春短編。AIによる成績評価がされる特殊クラスで友人が不登校になる。AIはイジメ問題解決の為に「ハミダシモノ」の立候補を求め、沢井亜子はハミダシモノになった。"
