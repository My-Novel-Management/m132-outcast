...
def this_rule(w: World):
    ...
    return w.scene('この高校のルール',
            ...
            ako.do("$noriの後ろの席に腰を下ろすと鞄から『義務について』とタイトルが書かれたクリーム色の文庫本を取り出す",
                "特別な装飾はなく、タイトルと作者名が書かれただけのとてもシンプルな一冊だ",
                "図書室で借りたのではなくネットで取り寄せたもので、",
            ...
            ako.talk("ああ、その通りだ"),
            ako.do("$noriとは中学一年以来の再会だったが今年新設された特別進学クラスで一緒になったのは何か特別な巡り合わせがあった、",
                "という訳ではない",
...
def outcast(w: World):
    ...
    return w.scene("ハミダシモノ",
            ...
            mizu.talk("みんな確認したと思いますが、$ln_nozaさんの件についてイジメがあったという報告が上がっていることは前に話した通りですが、",
            ...
            noza.talk("ねえ$misora"),
            ako.do("$ln_nozaはすぐにクラス長に意見を求めようと立ち上がったがそれよりも早く彼女は$akoの前にやってきて、頭を五度だけ傾けた"),
            ...
            ako.do("その言葉の裏側にはどうしても$Sにその役割を押し付けたいという思いが透けて見えたが、$Sは黙ったまま薄く笑みを浮かべてみる"),
