...
def this_rule(w: World):
    ...
    return w.scene('この高校のルール',
            ...
            ako.talk("おはよう"),
            ako.do("$noriの後ろの席に腰を下ろすと鞄からキケロの『義務について』という文庫本を取り出す",
                "図書室で借りたのではなくネットで取り寄せたものだ",
                "全寮制で外出も厳しく制限されていたがパソコンやインターネットの利用は許可されていた"),
            nori.do("$Sも同じものを取り出してその小さな唇に人差し指を当てながらこう話す"),
            nori.talk(""),
            # TODO
